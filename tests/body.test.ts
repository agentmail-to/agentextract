...
import { extractEmailBody, stripNoise } from '../body'

// ---------------------------------------------------------------------------
// Synthetic Tests for my code (body.ts)
// ---------------------------------------------------------------------------
...
describe('extractEmailBody — HTML — quote markers', () => {
    ...
    // text path's Signal 5 (From: header, isQuoteSignal in body.ts). We cut at the
